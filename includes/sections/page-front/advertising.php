    ...
    <div class="advertising__center">
      <ul class="advertising__list">
        ...
        <?php else : ?>
          <li class="item">
          <div class="item__top">реклама</div>
          <div class="item__title"><?php get_bloginfo("language") == 'ru' ? $advertising['ru'][0]['title'] : $advertising['ua'][0]['title'] ; ?><?= $advertising[0]['title'] ?></div>
          <div class="item__true"><?= get_bloginfo("language") == 'ru' ? 'на самом деле' : 'насправді'?></div>
          <div class="item__text"><?php get_bloginfo("language") == 'ru' ? $advertising['ru'][0]['text'] : $advertising['ua'][0]['text'] ; ?></div>
        </li>
        <li class="item empty">
          <div class="item__top">реклама</div>
          <div class="empty__title empty__line"></div>
